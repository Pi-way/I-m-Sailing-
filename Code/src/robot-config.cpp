...
motor RingLiftR = motor(PORT4, ratio6_1, false);
controller Controller1 = controller(primary);
controller Controller2 = controller(partner);
motor FrontLift = motor(PORT15, ratio36_1, true);
gps GPSLeft = gps(PORT12, 1.4, 5.57, inches, -2);
gps GPSRight = gps(PORT5, -2.86, -5.97, inches, 178); //vALUES FOR LEFT FIELD: gps GPS5 = gps(PORT5, 2.7, 5.60, inches, -3); (SLOT 8) ///////add x to make it smaller and add y to make it smaller 
